...
//
//
// class _AddCameraState extends State<AddImage> {
...
class _AddCameraState extends State<AddCamera> {
  ...
  chooseImage() async {
    final pickedFile = await picker.getImage(source: ImageSource.camera, imageQuality: 60, maxHeight: 1200, maxWidth: 1920);
    setState(() {
      _image.add(File(pickedFile!.path));
    });
    if (pickedFile!.path == null) retrieveLostData();
